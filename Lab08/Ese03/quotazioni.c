...
// DICHIARAZIONI: per BST ADT di prima classe
...
void SearchBSTQuotationMINMAXFromRangeDate(BST bst){
    ...
    Quotazione min, max;
    min = QuotazionesetNull(); min.valore = 500000;
...
void BSTbalance(BST bst){
    ...
    // La soglia S è definita come il rapporto tra l'altezza massima e minima dell'albero.
